...
namespace UseMVCApplication
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            tasks.Add(new CarrierTask(2, "Груз 84", "A sign in attempt requires further verification because we did not recognize your device. To complete the sign in, enter the verification code on the unrecognized device. Device:") { MapPicturePath = mapPath2 });
            ...
            tasks.Add(new CarrierTask(7, "Груз 2") { MapPicturePath = mapPath2 });
            tasks.Add(new CarrierTask(8, "Груз 6") { MapPicturePath = mapPath1 });
            tasks.Add(new CarrierTask(9, "Груз 45") { MapPicturePath = mapPath2 });
